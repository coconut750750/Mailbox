 ...
 */
public class RecyclerSwipeListener implements RecyclerView.OnItemTouchListener {
...
// Send a cancel event
    ...
    /**
     * The callback interface used by {@link RecyclerSwipeListener} to inform its client
